...
\begin{umlpackage}[y=-5]{LDP}
  ...
  \umlsimpleclass[below=0.5 of ResourceIdentifier.south west,anchor=north west]{Representation}
  ...
  \begin{umlpackage}[x=7.5,y=-3.5]{Operations}
    \umlclass[]{OperationFactory}{}{
      + OperationFactory(ResourceStore)\\
      + createOperation(method : string, target : ResourceIdentifier, \ldots) : Operation\\
    }
...
\begin{umlpackage}{Authorization}
  \umlinterface[below=4.5 of CredentialsExtractor.south east,anchor=north east]{Authorizer}{}{
