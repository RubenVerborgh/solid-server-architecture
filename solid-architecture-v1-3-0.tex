...
\newcommand\ResourceStoreBody{%
  ...
  + modifyRepresentation(ResourceIdentifier, Patch, Conditions?) : Promise<void>\\
}
...
\begin{umlpackage}[y=-5]{LDP}
  \umlclass{AuthenticatedLdpHandler}{}{
  }
  \umlimpl{AuthenticatedLdpHandler}{HttpHandler}

  \begin{umlpackage}[x=7]{HTTP}
    \umlsimpleclass[right=1 of AuthenticatedLdpHandler.north east]{ResponseWriter}
    \umluniaggreg[mult=1,above,anchor1=10,anchor2=west,geometry=-|-,arm1=0.5]{AuthenticatedLdpHandler}{ResponseWriter}
    ...
    \umlclass[below=.5 of ResponseWriter.south east,anchor=north east]{RequestParser}{}{
    }
    \umluniaggreg[mult=1,below,anchor1=-10,anchor2=west,geometry=-|-,arm1=0.5]{AuthenticatedLdpHandler}{RequestParser}
  ...
  \begin{umlpackage}[x=7,y=-9]{Operations}
    \umlinterface[]{OperationHandler}{}{
      + canHandle(Operation) : Promise<boolean>\\
      + handle(Operation) : Promise<ResponseDescription>\\
    }
    \umluniaggreg[anchor1=310,mult=1,geometry=|-]{AuthenticatedLdpHandler}{OperationHandler}

    \umlclass[above=1 of OperationHandler]{Operation}{
      + method : String\\
  ...
  \umldep[arg=creates,pos=0.5,left,geometry=|-|,arm1=-1.5]{RequestParser}{Operation}
\end{umlpackage}

\begin{umlpackage}{Storage}
  \umlinterface[below=4 of OperationHandler]{ResourceStore}{}{
    \ResourceStoreBody
  }
...
\begin{umlpackage}{Authentication}
  \umlinterface[left=2 of AuthenticatedLdpHandler.west]{CredentialsExtractor}{}{
    + extractCredentials(HttpRequest) : Promise<Credentials>\\
  }
  \umluniaggreg[mult=1]{AuthenticatedLdpHandler}{CredentialsExtractor}
...
\begin{umlpackage}{Authorization}
  ...
  \umluniaggreg[anchor1=230,mult=1,geometry=|-,weight=0.6]{AuthenticatedLdpHandler}{Authorizer}
...
Another consideration is \field{modifyRepresentation},
...
\field{modifyRepresentation} gives implementations the freedom
...
If it does not,
it can call \field{modifyRepresentation}
